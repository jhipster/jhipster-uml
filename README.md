...
This project's main goal is to bring support of UML files (from various editors) to JHipster so that it can read the files, without you answering the questions.
