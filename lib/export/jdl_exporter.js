...
const JHipsterFieldTypes = require('jhipster-core').JHipsterFieldTypes;
const JDLObject = require('jhipster-core').JDLObject;
const JDLEntity = require('jhipster-core').JDLEntity;
const JDLEnum = require('jhipster-core').JDLEnum;
const JDLField = require('jhipster-core').JDLField;
const JDLRelationship = require('jhipster-core').JDLRelationship;
const JDLValidation = require('jhipster-core').JDLValidation;
const JDLUnaryOption = require('jhipster-core').JDLUnaryOption;
const JDLBinaryOption = require('jhipster-core').JDLBinaryOption;
const UnaryOptions = require('jhipster-core').JHipsterUnaryOptions.UNARY_OPTIONS;
const BinaryOptions = require('jhipster-core').JHipsterBinaryOptions.BINARY_OPTIONS;
const BinaryOptionValues = require('jhipster-core').JHipsterBinaryOptions.BINARY_OPTION_VALUES;
...
function getFieldType(fieldData, parsedData) {
  assertFieldHasAValidType(parsedData, fieldData);
...
function assertFieldHasAValidType(parsedData, fieldData) {
  if (!parsedData.types[fieldData.type] && !parsedData.enums[fieldData.type]) {
    throw new BuildException(exceptions.WrongType, `The field ${fieldData.name} doesn't have a type.`);
  }
}
