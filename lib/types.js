...
var _this = this; //to reference the exported var from within the module 
/**
...
/**
* Returns if type is an instance of NoSQL database type
* @param {type} type to check
*/
exports.isNoSQL =  function (type){
  return _this.MongoDBTypes.prototype.isPrototypeOf(type) || 
         _this.CassandraTypes.prototype.isPrototypeOf(type);
}
