...
const isReservedClassName = require('jhipster-core').isReservedClassName;
const isReservedTableName = require('jhipster-core').isReservedTableName;
const isReservedFieldName = require('jhipster-core').isReservedFieldName;
...
function readJSONFiles(entityNames) {
  ...
  for (let i = 0; i < entityNames.length; i++) {
    const file = `.jhipster/${entityNames[i]}.json`;
