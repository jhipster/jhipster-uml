...
const HELP = 'Syntax: jhipster-uml <xmi file> [-options] [values]\n'
    + 'The options are:\n'
    ...
    + '\t-microservice-name \tAdds the microservice/s possessing the entity/ies.\n'
    + '\t-search-engine \tSpecifies the search engine for the selected entities.\n'
    + '\t-f or -force \tOverrides entities.\n'
    + '\t-h or -help \tDisplays this message.\n'
    + "\t-v or -version \tDisplays JHipster UML's version.\n\n"
    + "Adding values is useful to use the same option for all the entities.";
