...
const JHipsterBinaryOptionsValues = JHipsterCore.JHipsterBinaryOptions.Values;
  ...
  return yargs(realArgs)
    ...
    .option({
      ...
      dto: {
        ...
        choices: Object.values(JHipsterBinaryOptionsValues.dto)
      },
      paginate: {
        describe: 'Generates pagination',
        choices: Object.values(JHipsterBinaryOptionsValues.pagination)
      },
      service: {
        describe: 'Generates services',
        choices: Object.values(JHipsterBinaryOptionsValues.service)
      },
      'skip-client': {
      ...
      'search-engine': {
        ...
        choices: Object.values(JHipsterBinaryOptionsValues.searchEngine)
      },
