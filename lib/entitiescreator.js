...
var EntitiesCreator = module.exports = function (parsedData, databaseTypes, listDTO, listPagination, listService, microserviceNames, searchEngines) {
  if (!parsedData) {
    throw new buildException(
        exceptions.NullPointer, 'There is no parsed data.');
  }
