...
var EntitiesCreator = module.exports = function (args) {
  ...
  //the option list
  this.listDTO = merged.listDTO;
  this.listPagination = merged.listPagination;
  this.listService = merged.listService;
  this.microserviceNames = merged.microserviceNames;
  this.searchEngines = merged.searchEngines;
  this.databaseTypes = merged.databaseTypes;
  this.parsedData = merged.parsedData;
...
EntitiesCreator.prototype.setMicroserviceNames = function (entity, entityName) {
  if (this.microserviceNames.hasOwnProperty(entityName)) {
    entity.microserviceName = this.microserviceNames[entityName];
  }
  return entity;
};

EntitiesCreator.prototype.setSearchEngine = function(entity, entityName) {
  if (this.searchEngines.indexOf(entityName) !== -1) {
