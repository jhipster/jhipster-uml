...
EntitiesCreator.prototype.setBidirectionalRelationship = function(classId, injectId) {
  ...
  var relationshipOtherSide = {
    ...
    relationshipName: this.getAssociationFieldName(this.parsedData.getInjectedField(injectId).association, _s.camelize),
    relationshipFieldName: this.getAssociationFieldName(this.parsedData.getInjectedField(injectId).association, _s.camelize),
