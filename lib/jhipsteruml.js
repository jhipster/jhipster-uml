...
const noUserManagement = argv['skip-user-management'] != null;
...
const options = {
  ...
  noFluentMethods: (! argv['fluent-methods']) ? jhipsterOptionHelper.askForClassesWithNoFluentMethods(parsedData.classes) : []
};
