...
UMLDesignerParser.prototype.fillAssociations = function() {
  this.rawAssociationsIndexes.forEach(function(rawAssociationsIndex) {
    ...
    //  associationData.from = association.ownedEnd[1].$.type;
    //  associationData.to = association.ownedEnd[0].$.type;
    //  associationData.injectedFieldInFrom = association.ownedEnd[0].$.name;
    //  associationData.injectedFieldInTo = association.ownedEnd[1].$.name;
    //
    ...
    //} else {
      ...
      associationData.to = association.ownedEnd[1].$.type;
      associationData.injectedFieldInFrom = association.ownedEnd[1].$.name;
