...
exports.ModelioParser = parser.AbstractParser.extend({
  ...
  fillAssociations: function() {
    this.rawAssociationsIndexes.forEach(function(element) {
      ...
      var name = (association.ownedEnd != null) 
                   ...
                   : '';
      var type = (association.ownedEnd != null) 
                   ? association.ownedEnd[0].$['type'] 
                   : '';
      this.associations[association.$['xmi:id']] = {
        isUpperValuePresent: association.ownedEnd != null 
                              && association.ownedEnd[0].upperValue != null,
        name: name,
        type: type
      };
    }, this);
  ...
  fillConstraints: function() {
    this.rawValidationRulesIndexes.forEach(function(index) {
      ...
      if (this.fields[constraint.$['constrainedElement']] != null) {
        previousValidations = 
