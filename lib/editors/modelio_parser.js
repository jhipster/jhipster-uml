...
ModelioParser.prototype.addRegularField = function(element, classId) {
  ...
  this.parsedData.addField(classId, fieldData);
};
 ...
 */
ModelioParser.prototype.addInjectedField = function(element) {
  var association = this.parsedData.getAssociation(element.$.association);
  switch (element.$.aggregation) {
    ...
    case 'shared':
      if (element.upperValue && element.upperValue[0].$.value === '*'
        ...
        && association.type.hasOwnProperty('ONE_TO_MANY')) {
