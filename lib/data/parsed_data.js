...
const FieldData = require('./field_data');
const TypeData = require('./type_data');
const EnumData = require('./enum_data');
const AssociationData = require('./association_data');
const ValidationData = require('./validation_data');
