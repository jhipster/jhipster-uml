...
exports.DSL = parser.AbstractParser.extend({
  ...
  */
  ...
  fillAssociations: function() {
    ...
    for (var i = 0; i < relationships.length; i++){
      ...
      this.associations[associationsID] = {
        name : (relationship.to.injectedfield === '') ? relationship.from.name.toLowerCase() : relationship.to.injectedfield,
  ...
  addConstraint: function(constraintList, fieldId, type ){
